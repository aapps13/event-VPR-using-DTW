...
data_dir = 'C:/Users/angus/OneDrive - Australian National University/Honours/Data/Output Data/subsequence_dtw/Batch Output/masked_dtw/' + file_dir
...
for i in range(data_array.shape[0]):
    if i == 0:
        ground_truth_path, actual_position, estimated_position, distance= calc_ground_truth(query_file_name, query_time_array[i], reference_file_name, reference_time_array[i])
    else:
        _, actual_position, estimated_position, distance = calc_ground_truth(query_file_name, query_time_array[i], reference_file_name, reference_time_array[i])
...
for i in range(len(data_array)):
    ...
    im3 = ax3.imshow(M_mask)#, vmin=0, vmax=10)
